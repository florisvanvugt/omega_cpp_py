...
robot : Robot.cpp Robot.h BasicRobot.cpp BasicRobot.h Controllers.cpp struct_shm.h
	g++ Robot.cpp BasicRobot.cpp Controllers.cpp -o Robot -Llib -ldhd -lrt -lpthread -lusb-1.0 -Wall
