 ...
 ****************************************************************************/
  ...
  int         __SDK dhdEnableGripperForce                          (uchar val, char ID = -1);                                                                           /* added in release 3.7 */
  int         __SDK dhdGetSystemType                               (char ID = -1);
  const char* __SDK dhdGetSystemName                               (char ID = -1);                                                                                      /* added in release 3.2 */
  ...
  int         __SDK dhdSetOutput                                   (uint output, char ID = -1);                                                                         /* added in release 3.4 */
  ...
  int         __SDK dhdSetForceAndTorqueAndGripperForce            (double fx, double fy, double fz, double tx, double ty, double tz, double fg, char ID = -1);         /* added in release 3.3 */
  int         __SDK dhdGetForceAndTorqueAndGripperForce            (double *fx, double *fy, double *fz, double *tx, double *ty, double *tz, double *f, char ID = -1);   /* added in release 3.3 */
 ...
 ****************************************************************************/
  ...
  int         __SDK dhdDeltaEncodersToJointAngles                  (int enc0, int enc1, int enc2, double *j0, double *j1, double *j2, char ID = -1);                    /* added in release 3.7   */
  int         __SDK dhdDeltaJointAnglesToEncoders                  (double j0, double j1, double j2, int *enc0, int *enc1, int *enc2, char ID = -1);                    /* added in release 3.7   */
  int         __SDK dhdGetWristJointAngles                         (double *j0, double *j1, double *j2, char ID = -1);                                                  /* added in release 3.7   */
  int         __SDK dhdGetWristJacobian                            (double jcb[3][3], char ID = -1);                                                                    /* added in release 3.7   */
  int         __SDK dhdWristJointAnglesToJacobian                  (double j0, double j1, double j2, double jcb[3][3], char ID = -1);                                   /* added in release 3.7   */
  int         __SDK dhdWristJointTorquesExtrema                    (double j0, double j1, double j2, double minq[3], double maxq[3], char ID = -1);                     /* added in release 3.7   */
  int         __SDK dhdWristGravityJointTorques                    (double j0, double j1, double j2, double *q0, double *q1, double *q2, char ID = -1);                 /* added in release 3.7   */
  int         __SDK dhdSetWristJointTorques                        (double t0, double t1, double t2, char ID = -1);                                                     /* added in release 3.7   */
  int         __SDK dhdSetForceAndWristJointTorques                (double fx, double fy, double fz, double t0, double t1, double t2, char ID = -1);                    /* added in release 3.7   */
  int         __SDK dhdSetForceAndWristJointTorquesAndGripperForce (double fx, double fy, double fz, double t0, double t1, double t2, double fg, char ID = -1);         /* added in release 3.7   */
  int         __SDK dhdWristEncodersToJointAngles                  (int enc0, int enc1, int enc2, double *j0, double *j1, double *j2, char ID = -1);                    /* added in release 3.7   */
  int         __SDK dhdWristJointAnglesToEncoders                  (double j0, double j1, double j2, int *enc0, int *enc1, int *enc2, char ID = -1);                    /* added in release 3.7   */
  int         __SDK dhdGetJointAngles                              (double j[DHD_MAX_DOF], char ID = -1);                                                               /* added in release 3.3   */
  int         __SDK dhdGetJointVelocities                          (double v[DHD_MAX_DOF], char ID = -1);                                                               /* added in release 3.7   */
  int         __SDK dhdGetEncVelocities                            (double v[DHD_MAX_DOF], char ID = -1);                                                               /* added in release 3.7.1 */
